    ...
    public class HeaderFeatureVectorFactory
    {
        ...
        public HeaderFeatureVector Create(BlockState blockState)
        {
            var fv = new HeaderFeatureVector
            {
                ...
                Suffix1 = this.featureExtractor.Prefix(blockState.Text, 1),
                Suffix2 = this.featureExtractor.Prefix(blockState.Text, 2),
                Suffix3 = this.featureExtractor.Prefix(blockState.Text, 3),
                Suffix4 = this.featureExtractor.Prefix(blockState.Text, 4),
                ...
                IsEmail = this.featureExtractor.IsEmailAddress(blockState.Text),
